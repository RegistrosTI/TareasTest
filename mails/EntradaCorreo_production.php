<?php
	...
	function comprobacionDestinatarios($Destinatarios){
		if(property_exists($Destinatarios,'to')){
			...
			$tocorreo = $Destinatarios -> to [ 0 ] -> mailbox . "@" . $Destinatarios -> to [ 0 ] -> host;
						
			$msjCorreoAutomaticoInfo ='<br/><br/><br /><span style:"color:red"><b>Este correo se envía de forma automática, por favor no responda a este mensaje.</b></span>';
	...
	function montarSQLCorreo($inbox,$email_number){
		...
		//enviarmail ( $from , "Se ha creado la solicitud para su valoración." , "Su solicitud de tarea con asunto : ". imap_utf8 ( $subject ) ."<br/><br/> Ha sido creada en el sistema para su valoración <br/><br/> <br/> <br/> <br/> <u><b> Este correo se envía de forma automática, por favor no responda a este mensaje. <br/> La creación de la solicitud es automática, pero la creación de tareas está bajo valoración.</b></u>", $mensajeid );
                enviarmail ( $from , "Se ha creado la solicitud para su valoración." , "Su solicitud de tarea con asunto : ". imap_utf8 ( $subject ) ."<br/><br/> Ha sido creada en el sistema para su valoración <br/><h3 style='color:red;'>No se admitirán y se rechazarán todas las solicitudes si estas no llevan en copia a su jefe directo o director, tal y como indica el método SES para solicitar tareas a TI y que puede descargar <a href='https://ses.sp-berner.com/get_file.php?ses=SES-01-090-0001'>aquí</a>.</h3><br/><br/> <u><b> Este correo se envía de forma automática, por favor no responda a este mensaje. <br/> La creación de la solicitud es automática, pero la creación de tareas está bajo valoración.</b></u>", $mensajeid );
