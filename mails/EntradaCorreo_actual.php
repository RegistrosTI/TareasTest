<?php
	...
	$actual_link = strtoupper("http://$_SERVER[HTTP_HOST]");
	...
	if ($emails) {
		...
		foreach ( $emails as $email_number ) {
			...
			print("<pre>".print_r('this is email numbre:'.$email_number,true)."</pre>");
			
			//$g = imap_fetchheader( $inbox , $email_number );
			//print("<pre>".print_r('esto es g:'.$g,true)."</pre>");

			$codificacion =  imap_fetchstructure($inbox, $email_number);
			print("<pre>".print_r($codificacion,true)."</pre>");
			die();	
