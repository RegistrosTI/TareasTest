...
if(isset($_POST['departamento']))
{
    ...
    $departamento_programa=$Departamento_Alta;
if(isset($_POST['programa']))
{
    ...
    $programa_programa=$Programa_Alta;
...
$selectdepartamento_programa='<select id="selectprogramaalta" name="selectprogramaalta" style="width:250;">';	
$i_programa                 = 1;
...
{
	$selectdepartamento_programa_buscado = '<div id="div_programaalta">'.$selectdepartamento_programa.'</div>';
}
if ($esajax == true)
{
	DBClose();	
