...
class UploadHandler
{
    ...
    protected $error_messages = array(
        ...
        'max_height' => 'La imagen supera la altura máxima',
        'min_height' => 'La imagen requiere una altura mínima',
        'abort' => 'Carga de archivo cancelada',
        'image_resize' => 'No se pudo cambiar el tamaño de la imagen'
    );
    ...
    public function __construct($options = null, $initialize = true, $error_messages = null) {
        $this->options = array(
            ...
            'readfile_chunk_size' => 30 * 1024 * 1024, // 30 MiB
            ...
            'accept_file_types' => '/\.(gif|jpe?g|png|bmp|pdf|doc|docx|xls|xlsx|ppt|ppt|mp3|mp4|avi|mkv|wmv|wma|eml|msg)$/i',
